...
The reason why both Ports, 80 and 443 were allowed even though I would have only preferred to allow Port 443 for safety reasons; this is to ensure that whenever a user visits my website and they type the address/url of my portfolio in the search bar, a big warning does not appera that may suggest that the website is faulty or broken thus making the user skeptical. Security is great, but user experience (UX) must also be priorotized. 
