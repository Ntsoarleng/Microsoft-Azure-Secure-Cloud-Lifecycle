...
2. Clicked on Azure CLI. Two options were provided: Bash and Powershell. Chose Bash as it is the kernel I am most familiar with.
3. I then enterned the command to create the resource group, name it, choose its region, and create, as shown on the screenshot below:
